 ...
 * @type {ReactClass}
 */
var THref = function (_React$Component) {
    _inherits(THref, _React$Component);

    function THref() {
        _classCallCheck(this, THref);

        return _possibleConstructorReturn(this, (THref.__proto__ || Object.getPrototypeOf(THref)).call(this));
    }
